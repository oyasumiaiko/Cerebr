...
async function main() {
  ...
  try {
    ...
    await cardRoot.locator('.conversation-document-card__button').filter({ hasText: 'Edit' }).click();
    ...
    await cardRoot.locator('.conversation-document-card__button').filter({ hasText: 'Download' }).click();
