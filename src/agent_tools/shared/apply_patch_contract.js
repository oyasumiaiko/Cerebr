...
export const APPLY_PATCH_RUNTIME_WIRE_VERSION = 2;
export const APPLY_PATCH_PARSER_REVISION = 'codex-63d2138';
export const APPLY_PATCH_GRAMMAR_REVISION = 'codex-63d2138-environment-id';
export const APPLY_PATCH_RUNTIME_CONTRACT_ID = 'codex-apply-patch@63d2138/cerebr-v2';
